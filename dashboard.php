...
@media (max-width: 768px) {
    ...
    .card {
        width: 100%; /* Card memenuhi lebar */
        max-width: 300px; /* Maksimum lebar card */
        margin: 10px 0; /* Jarak antar card */
    }
    ...
    .map iframe {
        width: 100%; /* Peta responsif */
        height: 200px; /* Tinggi peta */
    }

    .whatsapp-btn {
        bottom: 15px; /* Sesuaikan posisi tombol */
        right: 15px; /* Sesuaikan posisi tombol */
    }
}
...
<body>
    ...
    <div class="visi-misi-content">
        ...
        <section id="ukm">
            ...
            <br>
            <a class="btn-primary" href="himpunan_tampil.php">Tambah Kegiatan</a>
        </section>
        <section>
