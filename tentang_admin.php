...
<body>
    ...
    <h1>Temukan Minat dan Bakatmu</h1>
    <h3>Ayo daftar sekarang dan pilih minat UKM mu</h3>
    <!-- Formulir Tambah UKM -->
    <form id="food-form" action="ukm_insert.php" method="post" enctype="multipart/form-data">
        <h2>Daftar UKM</h2>
        <label for="nama_ukm">Nama UKM:</label>
        <input type="text" id="nama_ukm" name="nama_ukm" placeholder="Masukkan nama..." required 
               oninvalid="this.setCustomValidity('Ups! Kolom ini tidak boleh kosong')" 
               oninput="setCustomValidity('')">
        
        <label for="deskripsi">Deskripsi UKM:</label>
        <input type="text" id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi UKM..." required 
               oninvalid="this.setCustomValidity('Ups! Kolom ini tidak boleh kosong')" 
               oninput="setCustomValidity('')">
